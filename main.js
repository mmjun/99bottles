...
window.onload = function() {
  ...
  button.onclick = function(event) {
    ...
    var newThing = bottles[Math.floor(Math.random() * (bottles.length))];

    addToList(thingList, newThing);
  };
};

var bottles = ["99 bottles of beer on the wall, 99 bottles of beer. Take one down and pass it around, 98 bottles of beer on the wall." ,
